  ...
  createServer({
    ...
    seeds(server) {
      server.create("product", {
        id: 1,
        name: "Men's Vega Running Shoes",
        img: "https://m.media-amazon.com/images/I/71iXen7CNrL._AC_UL480_FMwebp_QL65_.jpg",
        price: 600,
        mrp: 1000,
        inStock: true,
        fastDel: true,
      ...
      server.create("product", {
        id: 2,
        name: "Reebok Men's Advanced Trainer shoe",
        img: "https://m.media-amazon.com/images/I/71XAwuGa9BL._UX575_.jpg",
        mrp: 6000,
        price: 3500,
        inStock: true,
        fastDel: false,
      ...
      server.create("product", {
        id: 3,
        name: "Puma Men's Nitro Running Shoe",
        img: "https://m.media-amazon.com/images/I/81dVruPYn3S._UX575_.jpg",
        mrp: 9820,
        price: 7000,
        inStock: false,
        fastDel: true,
      ...
      server.create("product", {
        id: 4,
        name: "Puma Unisex-Adult Yuri Idp Running Shoe",
        img: "https://m.media-amazon.com/images/I/81C4-6WRF6L._UX575_.jpg",
        mrp: 2000,
        price: 1540,
        inStock: true,
        fastDel: false,
      ...
      server.create("product", {
        id: 5,
        name: "Nike Men's Downshifter 11 Running Shoe",
        img: "https://m.media-amazon.com/images/I/81HOL5l1leS._UX575_.jpg",
        mrp: 4000,
        price: 2800,
        inStock: true,
        fastDel: true,
      ...
      server.create("product", {
        id: 6,
        name: "Nivia PLUNK Jogging Shoe",
        img: "https://m.media-amazon.com/images/I/61cJHsUw2EL._UY575_.jpg",
        mrp: 1000,
        price: 950,
        inStock: false,
        fastDel: false,
      ...
      server.create("product", {
        id: 7,
        name: "Bacca Bucci Marvel Men Fashion Sneakers",
        img: "https://m.media-amazon.com/images/I/71jgR+mHB+S._UY575_.jpg",
        mrp: 3000,
        price: 1300,
        inStock: true,
        fastDel: true,
        brand: "Bacca",
        description: [
          "Sole: Phylon-Rubber & Light weight EVA",
          "Closure: Lace-Up",
      ...
      server.create("product", {
        ...
        img: "https://m.media-amazon.com/images/I/71x2B+qVzQL._UY575_.jpg",
        mrp: 800,
        price: 450,
        inStock: false,
        fastDel: true,
      ...
      server.create("product", {
        id: 9,
        name: "Reebok Men's Wonder-13 Sports Shoes",
      ...
      server.create("product", {
        id: 10,
        name: "Kraasa Leather Long Boots for Men",
        img: "https://m.media-amazon.com/images/I/61xXnvJ8JiS._AC_UL320_.jpg",
        mrp: 8745,
        price: 5555,
        inStock: true,
        fastDel: true,
